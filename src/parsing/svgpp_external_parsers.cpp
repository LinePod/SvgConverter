...
SVGPP_PARSE_PAINT_IMPL(const char *, svgpp::factory::color::default_factory,
                       svgpp::factory::icc_color::default_factory)
SVGPP_PARSE_COLOR_IMPL(const char *, svgpp::factory::color::default_factory,
                       svgpp::factory::icc_color::default_factory)
